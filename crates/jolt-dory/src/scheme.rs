...
mod tests {
    ...
    fn zk_open_verify_round_trip() {
        ...
        // Reusing a supplied evaluation must not allow a false opening.
        let mut bad_prove_transcript = jolt_transcript::Blake2bTranscript::new(b"zk-test");
        ...
        .unwrap();
        let mut bad_verify_transcript = jolt_transcript::Blake2bTranscript::new(b"zk-test");
